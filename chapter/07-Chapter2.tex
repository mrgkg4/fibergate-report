...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth,max width=\textwidth]{images/image9.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth,max width=\textwidth]{images/image10.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth,max width=\textwidth]{images/image11.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth,max width=\textwidth]{images/image12.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth,max width=\textwidth]{images/image13.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth,max width=\textwidth]{images/image14.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth,max width=\textwidth]{images/image15.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth,max width=\textwidth]{images/image16.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth,max width=\textwidth]{images/image17.png}
...
The following subsections survey the academic and industrial literature across three technology domains that are directly relevant to the FiberGate solution: Robotic Process Automation and intelligent automation frameworks, Document Artificial Intelligence and multimodal learning models, and enterprise web application and cloud architecture patterns. Each subsection concludes with a positioning of the selected technology relative to evaluated alternatives.
